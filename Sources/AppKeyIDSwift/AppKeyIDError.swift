...
public enum AppKeyIDError: Error {
            ...
            if httpResponse.statusCode == 200 {
                ...
                if let json = (try? JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions.mutableContainers)) as? [String: Any] {
                    if let code = json["code"] as? Int {
                        ...
                        case 400:
                            throw AppKeyIDError.invalidAppToken
                        case 401:
                            throw AppKeyIDError.appNoLongerExist
                        case 402:
                            throw AppKeyIDError.appSuspended
                        case 403:
                            throw AppKeyIDError.missingParameter
                        case 404:
                            throw AppKeyIDError.accountSuspended
                        case 405:
                            throw AppKeyIDError.invalidAccessToken
                        case 406:
                            throw AppKeyIDError.appInviteNotSupported
                        case 407:
                            throw AppKeyIDError.appSignupNotSupported
                        case 408:
                            throw AppKeyIDError.appGoogle2FactorNotSupported
                        case 409:
                            throw AppKeyIDError.appPhone2FactorNotSupported
                        case 410:
                            throw AppKeyIDError.appUserPhoneNotVerified
                        case 411:
                            throw AppKeyIDError.expiredSignupCode
                        case 412:
                            throw AppKeyIDError.phoneNumberInUse
                        case 413:
                            throw AppKeyIDError.appIsMirgrated
                        case 414:
                            throw AppKeyIDError.anonymousLoginNotSupported
                        case 415:
                            throw AppKeyIDError.appleLoginNotSupported
                        case 416:
                        ...
                        case 601:
                            throw AppKeyIDError.handleAlreadyRegistered
                        case 602:
                            throw AppKeyIDError.invalidData
                        case 603:
                            throw AppKeyIDError.accountDoesNotExist
                        case 604:
                            throw AppKeyIDError.invalidMetaData
                        case 605:
                            throw AppKeyIDError.userNameAlreadyInUse
                        case 606:
                            throw AppKeyIDError.appIsNotSupporUserName
                        case 607:
                            throw AppKeyIDError.userNameDoesNotExist
                        case 608:
                            throw AppKeyIDError.accountIsNotVerify
                        case 609:
                            throw AppKeyIDError.invalidLocale
                        case 610:
                            throw AppKeyIDError.emailAccountExists
                        case 611:
                            throw AppKeyIDError.appleAccountExists
                        case 612:
                            throw AppKeyIDError.googleAccountExists
                        case 613:
                            throw AppKeyIDError.invalidToken
                        case 614:
                            throw AppKeyIDError.passkeyNotExist
                        case 615:
                            throw AppKeyIDError.invalidPasskey
                        case 616:
                            throw AppKeyIDError.accountAlreadyExist
                        case 617:
                            throw AppKeyIDError.invalidHandleFormat
