//
//  AppKeyIDGoogleAuth.swift
//  AppKeyIDSwift
//
//  Created by Tola Voeung on 9/9/25.
//
...
@available(iOS 15, *)
@MainActor public var AppKeyGAuth = AppKeyIDGoogleAuth.shared


@available(iOS 15, *)
@MainActor public class AppKeyIDGoogleAuth: ObservableObject {
    
    public static let shared = AppKeyIDGoogleAuth()
